...
import { Button } from '@all-in-one/shared-ui';
import { validateEmail, API_ENDPOINTS } from '@all-in-one/shared-utils';

export default function Index() {
  const handleLogin = () => {
    console.log('Login clicked - API endpoint:', API_ENDPOINTS.AUTH);
  };
      ...
      <div className="wrapper">
        <div className="container">
          <div id="welcome">
            <h1>
              ...
              Welcome @all-in-one/auth-microfrontend 👋
            </h1>
          </div>

          <div className="mb-8 p-6 bg-gray-100 rounded-lg">
            <h2 className="text-xl font-bold mb-4">Shared Components Demo</h2>
            <div className="space-y-4">
              <div>
                <Button onClick={handleLogin} variant="primary">
                  Login with Shared Button
                </Button>
              </div>
              <div>
                <Button 
                  onClick={() => handleEmailValidation('test@example.com')} 
                  variant="secondary"
                >
                  Validate Email (Shared Utility)
                </Button>
              </div>
              <div>
        ...
        <div id="commands" className="rounded shadow">
          ...
          <details>
            ...
            <pre>nx show project @all-in-one/auth-microfrontend --web</pre>
          </details>
          <details>
            <summary>
              <svg
